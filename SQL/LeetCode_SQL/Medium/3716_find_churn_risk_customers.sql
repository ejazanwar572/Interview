...
Difficulty: Medium
Table Names: subscription_events
Description:
    - Database
...
Write a solution to Find Churn Risk Customers - users who show warning signs before churning. A user is considered <b>churn risk customer</b> if they meet ALL the following criteria:
