...
Write a solution to count the number of overlapping shifts for each employee. Two shifts are considered overlapping if one shift&rsquo;s end_time is later than another shift&rsquo;s start_time.
