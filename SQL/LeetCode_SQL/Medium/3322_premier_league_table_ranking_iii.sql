...
Write a solution to calculate the points, goal difference, and <b>position </b>for each team in each season. The position ranking should be determined as follows:
...
Return the result table ordered by season_id in ascending order, then by <font face="monospace">position </font>in ascending order, and finally by team_name in ascending order.
...
INSERT INTO SeasonStats (season_id, team_id, team_name, matches_played, wins, draws, losses, goals_for, goals_against) VALUES
    (2021, 1, 'Manchester City', 38, 29, 6, 3, 99, 26),
    (2021, 2, 'Liverpool', 38, 28, 8, 2, 94, 26),
    (2021, 3, 'Chelsea', 38, 21, 11, 6, 76, 33),
    (2021, 4, 'Tottenham', 38, 22, 5, 11, 69, 40),
