...
SELECT  a.Number as StepNumber,
        IFNULL(b.Lead_StepNumber,a.Number) AS Lead_StepNumber,
        c.DiceRoll AS DiceRoll_Actual,
        CASE WHEN a.Number = b.StepNumber THEN b.DiceRoll ELSE IFNULL(b.DiceRoll,0) * - 1 END AS DiceRoll_Modified
